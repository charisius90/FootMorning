		...
		<div id="page-content-wrapper">
			<div class="col-md-10">
				...
				<table class="table table-boardead table-hover" style="text-align: center;">
					...
					<!-- 게시글 내용이 들어가는 부분 -->
					<tbody>
						<c:forEach items="${list}" var="ComDiscussionKorDTO">
			               <tr align="center">
			               	  <td></td>
			               	  <td>${ComDiscussionKorDTO.com_discussion_kor_no}</td>
			                  <td><a href="/com/kor/read?com_discussion_kor_no=${ComDiscussionKorDTO.com_discussion_kor_no}">${ComDiscussionKorDTO.com_discussion_kor_subject}</a></td>
