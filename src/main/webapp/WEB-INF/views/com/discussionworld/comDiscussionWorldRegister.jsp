	...
	<div class="row">
		<div id="wrapper">
			...
			<div class="col-md-10">
				...
				<!-- 글쓰는 부분 -->
				<form method="POST" action="/com/discussionworld/comDiscussionWorldRegister">
				...
				<div align="right">
					...
					<a href="/com/discussionworld/comDiscussionWorldListAll" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>취소</a>
				</div>		
				</div>	
			</div>
		</div>
