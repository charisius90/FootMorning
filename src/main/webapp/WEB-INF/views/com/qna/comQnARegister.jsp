	...
	<div class="row">
		<div id="wrapper">
			...
			<div class="col-md-10">
				...
				<!-- 글쓰는 부분 -->
				<form method="POST" action="/com/qna/comQnARegister">
					...
					<div class="container">
						<div class="row">
							<table class="table">
								<tr>
									<td>제목</td>
									<td><input type="text" name="com_qna_subject"/></td>
								</tr>
								<tr>
									<td>작성자</td>
								...
								<tr>
									<td>내용</td>
									<td><textarea name="com_qna_content" rows="10" cols="100"></textarea></td>
								</tr>
							</table>
						</div>
					</div>
				...
				<hr/>
					...
					<a href="/com/qna/comQnAListAll" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>취소</a>
					</div>		
				</div>	
			</div>
		</div>
