...
<div class="container-fluid">
	<div class="row">
		<div id="wrapper">
			...
			<form name="f1" method="post" action="/com/qna/register">
				...
				<div class="container">
					<div class="row">
						<table class="table">
		                     <tr>
		                        <td>제목</td>
		                        <td><input type="text" id="com_qna_subject" name="com_qna_subject" /></td>
		                     </tr>
		                     <tr>
		                        <td>작성자</td>
		                        <td><input type="text" name="com_qna_writer" value="${USER_KEY.mem_name}"/></td>
		                     </tr>
		                     <tr>
		                        <td>내용</td>
								<td><textarea name="com_qna_content" id="ir1" rows="10" cols="100"
...
// 																	[ "로딩이 완료된 후에 본문에 삽입되는 text입니다." ]);
									...
									function submitContents(elClickedObj) {
										...
										var title = document.getElementById("com_qna_subject").value;
...
// 											$("#subject").focus();
				...
				<div align="right">
					...
					<a href="/com/qna/main" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>취소</a>
				</div>		
				</div>
			</div>	
			</form>
