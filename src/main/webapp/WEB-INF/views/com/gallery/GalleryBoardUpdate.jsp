...
<div class="container-fluid">
   <div class="row">
      <div id="wrapper">
         ...
         <form name="f1" method="post" action="/com/gallery/update">
   		 <input type='hidden' name='com_gallery_no' value="${dto.com_gallery_no}">
         <div class="col-md-10">
            ...
            <div class="container">
               <div class="row">
                  <table class="table">
                     <tr>
                        <td>제목</td>
                        <td><input type="text" id="com_gallery_subject" name="com_gallery_subject" value="${dto.com_gallery_subject}"/></td>
                     </tr>
                     <tr>
                        <td>작성자</td>
                        <td><input type="text"  value="${dto.com_gallery_writer}"/></td>
                     </tr>
                     <tr>
                        <td>내용</td>
                        <td><textarea rows="10" cols="100" id="ir1" name="com_gallery_content">${dto.com_gallery_content}</textarea>
...
// 										에디터의 내용에 대한 값 검증은 이곳에서 document.getElementById("ir1").value를 이용해서 처리하면 됩니다.
            ...
            <div align="right">
               ...
               <a href="/com/gallery/main" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>목록</a>
            </div>      
            </div>
         </div>   
      </form>
