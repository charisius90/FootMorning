				...
				<table class="table table-boardead table-hover" style="text-align: center;">
					...
					<tbody>
						<c:forEach items="${list}" var="comDTO">
			               <tr align="center">
			               	  <td></td>
			               	  <td>${comDTO.com_gallery_no}</td>
			                  <td><a href="/com/gallery/read?com_gallery_no=${comDTO.com_gallery_no}">${comDTO.com_gallery_subject}</a></td>
			                  <td>${comDTO.com_gallery_writer}</td>
			                  <td>${comDTO.com_gallery_regdate}</td>
			                  <td>${comDTO.com_gallery_count}</td>
			               </tr>
	              		</c:forEach>
					</tbody>
				</table>
				...
				<div class="container-fluid">
					<div class="row">
						...
						<div style="float: right;">
							<a href="/com/gallery/register" class="btn btn-default" type="submit"><span class="glyphicon glyphicon-pencil"></span>글쓰기</a>
						</div>
					</div>
				</div> <!-- /container-fluid -->
