				...
				<table class="table table-boardead table-hover" style="text-align: center;">
					...
					<tbody>
						<c:forEach items="${list}" var="myclubDTO">
			               <tr align="center">
			               	  <td></td>
			               	  <td>${myclubDTO.myclub_video_no}</td>
			                  <td><a href="/myclub/video/read?myclub_video_no=${myclubDTO.myclub_video_no}">${myclubDTO.myclub_video_subject}</a></td>
			                  <td>${myclubDTO.myclub_video_writer}</td>
			                  <td>${myclubDTO.myclub_video_regdate}</td>
			                  <td>${myclubDTO.myclub_video_count}</td>
			               </tr>
	              		</c:forEach>
					</tbody>
				</table>
