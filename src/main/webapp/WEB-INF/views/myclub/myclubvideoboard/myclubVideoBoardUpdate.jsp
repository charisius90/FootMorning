...
<div class="container-fluid">
   <div class="row">
      <div id="wrapper">
         ...
         <form name="f1" method="post" action="/myclub/video/update">
   		 <input type='hidden' name='myclub_video_no' value="${dto.myclub_video_no}">
         <div class="col-md-10">
            ...
            <div class="container">
               <div class="row">
                  <table class="table">
                     <tr>
                        <td>제목</td>
                        <td><input type="text" id="myclub_video_subject" name="myclub_video_subject" value="${dto.myclub_video_subject}"/></td>
                     </tr>
                     <tr>
                        <td>작성자</td>
                        <td><input type="text"  value="${dto.myclub_video_writer}"/></td>
                     </tr>
                     <tr>
                        <td>내용</td>
                        <td><textarea rows="10" cols="100" id="ir1" name="myclub_video_content">${dto.myclub_video_content}</textarea>
...
// 										에디터의 내용에 대한 값 검증은 이곳에서 document.getElementById("ir1").value를 이용해서 처리하면 됩니다.
            ...
            <div align="right">
               ...
               <a href="/myclub/video/main" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>목록</a>
            </div>      
            </div>
         </div>   
      </form>
