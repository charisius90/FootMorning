            ...
            <div class="container">
               <div class="row">
                  <table class="table">
                     <tr>
                        <td>제목</td>
                        <td><input type="text" id="myclub_album_subject" name="myclub_album_subject" value="${dto.myclub_album_subject}"/></td>
                     </tr>
                     <tr>
                        <td>작성자</td>
                        <td><input type="text"  value="${dto.myclub_album_writer}"/></td>
                     </tr>
                     <tr>
                        <td>내용</td>
                        <td><textarea rows="10" cols="100" id="ir1" name="myclub_album_content">${dto.myclub_album_content}</textarea>
...
// 										에디터의 내용에 대한 값 검증은 이곳에서 document.getElementById("ir1").value를 이용해서 처리하면 됩니다.
            ...
            <div align="right">
               ...
               <a href="/myclub/album/main" class="btn btn-default"><span class="glyphicon glyphicon-remove"></span>목록</a>
            </div>      
            </div>
         </div>   
      </form>
