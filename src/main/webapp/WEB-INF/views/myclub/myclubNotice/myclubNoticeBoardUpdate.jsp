	...
	<div class="row">
		<div id="wrapper">
			...
			<div class="col-md-10">
				...
				<div align="right">
					<a href="/myclub/notice/main" class="btn btn-default"><span class="glyphicon glyphicon-pencil"></span>수정</a>
					<button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-align-justify"></span>목록</button>
