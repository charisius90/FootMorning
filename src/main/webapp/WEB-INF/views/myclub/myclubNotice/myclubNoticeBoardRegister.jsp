				...
				<div class="container">
					<div class="row">
						<table class="table">
		                     <tr>
		                        <td>제목</td>
		                        <td><input type="text" id="myclub_notice_subject" name="myclub_notice_subject" /></td>
		                     </tr>
		                     <tr>
		                        <td>작성자</td>
		                        <td><input type="text" id="myclub_notice_writer" name="myclub_notice_writer" value="${USER_KEY.mem_name}"/></td>
		                     </tr>
		                     <tr>
		                        <td>내용</td>
								<td><textarea name="myclub_notice_content" id="ir1" rows="10" cols="100"
...
// 																	[ "로딩이 완료된 후에 본문에 삽입되는 text입니다." ]);
									...
									function submitContents(elClickedObj) {
										...
										var title = document.getElementById("myclub_notice_subject").value;
