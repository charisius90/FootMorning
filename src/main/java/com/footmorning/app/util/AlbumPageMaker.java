...
public class AlbumPageMaker {
	...
	private AlbumCriteria cri;

	public void setCri(AlbumCriteria cri) {
		this.cri = cri;
	}
	...
	// 그러면 조회페이지에서 페이징, 검색정보를 유지하고 있기 떄문에 다시 리스트 페이지로 이동할 때 원레 page와 검색 조건의 리스트로
	// 이동할 수 있다.
